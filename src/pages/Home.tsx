...
const featuredDishes: Dish[] = [
  {
    id: '1',
    name: 'كبسة لحم بلدي',
    description: 'لحم بلدي طازج مطهو على أصوله بالطريقة التقليدية مع الأرز البسمتي الفاخر.',
    price: 85,
    image: '/png.jpeg',
    category: 'rice'
  },
  {
    id: '2',
    name: 'جريش سعودي أصيل',
    description: 'الجريش على طريقة الأجداد بالسمن البري والبصل المحمر والمذاق لا يقاوم.',
    price: 45,
    image: '/png (2).jpeg',
    category: 'daily'
  },
  {
    ...
    description: 'رقاق القرصان الطري المغمور بمرقة اللحم البلدي والخضار الطازجة.',
    price: 55,
    image: '/png (3).jpeg',
    category: 'daily'
  },
  {
    id: '4',
    name: 'حنيني فاخر',
    description: 'التمر البرحي المفتوت بر البر مع السمن البري الأصلي والهيل.',
    price: 35,
    image: '/png.jpeg',
    category: 'desserts'
  }
